...
export class SecurityScanner {
    ...
    static sensitiveFileNames = [
        { pattern: /^\.env(?:\.[\w.-]+)?$/i, severity: 'HIGH', name: 'Environment secrets file' },
        { pattern: /\.(?:pem|key|pfx|p12)$/i, severity: 'HIGH', name: 'Cryptographic private key/certificate file' },
        { pattern: /(?:id_rsa|id_ed25519|id_ecdsa)(?:\.pub)?$/i, severity: 'HIGH', name: 'SSH key file' },
        { pattern: /(?:credentials|secrets|service-account)\.json$/i, severity: 'HIGH', name: 'Service account / credentials JSON' },
    ];
    static scan(workspaceRoot) {
