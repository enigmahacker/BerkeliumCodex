...
export class SystemScanner {
    static scan() {
        ...
        if (os.platform() === 'darwin' && os.arch() === 'arm64') {
            ...
            if (cpuModel.includes('M4 Max'))
                gpuCores = 40;
            else if (cpuModel.includes('M4 Pro'))
                gpuCores = 20;
            else if (cpuModel.includes('M4'))
                gpuCores = 10;
            else if (cpuModel.includes('M3 Max'))
                gpuCores = 40;
            else if (cpuModel.includes('M3 Pro'))
                gpuCores = 18;
            else if (cpuModel.includes('M3'))
                gpuCores = 10;
            else if (cpuModel.includes('M2 Max'))
                gpuCores = 38;
            else if (cpuModel.includes('M2 Pro'))
                gpuCores = 19;
            else if (cpuModel.includes('M2'))
                gpuCores = 10;
            else if (cpuModel.includes('M1 Max'))
                gpuCores = 32;
            else if (cpuModel.includes('M1 Pro'))
                gpuCores = 16;
            else if (cpuModel.includes('M1'))
                gpuCores = 8;
            else
                gpuCores = 8;
        }
    ...
    static formatReport(info, section) {
...
//# sourceMappingURL=system-scanner.js.map