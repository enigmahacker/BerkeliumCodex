 ...
 */
function isPrivateIpv4(num) {
    const octet1 = (num >>> 24) & 255;
    const octet2 = (num >>> 16) & 255;
    // 0.0.0.0/8
    if (octet1 === 0)
        return { private: true, reason: 'Current network (0.0.0.0/8)' };
    // 127.0.0.0/8 Loopback
    if (octet1 === 127)
        return { private: true, reason: 'Loopback address (127.0.0.0/8)' };
    // 10.0.0.0/8 Private
    if (octet1 === 10)
        return { private: true, reason: 'Private RFC1918 range (10.0.0.0/8)' };
