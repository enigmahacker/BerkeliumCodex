 ...
 */
export type ModelCapability = 'chat' | 'code' | 'reasoning' | 'vision' | 'tool_calling' | 'structured_output' | 'embeddings' | 'long_context' | 'streaming';
...
export type AppleSiliconChip = 'M1' | 'M2' | 'M3' | 'M4' | 'M1 Pro' | 'M1 Max' | 'M1 Ultra' | 'M2 Pro' | 'M2 Max' | 'M2 Ultra' | 'M3 Pro' | 'M3 Max' | 'M3 Ultra' | 'M4 Pro' | 'M4 Max' | 'M4 Ultra' | 'unknown';
