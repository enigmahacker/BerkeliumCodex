...
export class InputStateMachine {
    ...
    async recomputeState() {
        ...
        if (spaceIndex === -1) {
            ...
            if (cmd && cmd.arguments && cmd.arguments.length > 0) {
                ...
                this.currentArgumentMatches = await CompletionEngine.getArgumentSuggestions(this.executionContext, cmd, this.activeArgIndex, argQuery);
    ...
    buildResult(overrides) {
        const shouldRender = (this.mode === 'SlashCommand' && this.currentCommandMatches.length > 0) ||
...
//# sourceMappingURL=input-state-machine.js.map