...
export class StatusCommand {
    static async run(themeManager, configManager, router, json = false) {
        ...
        console.log(`Active Model:  ${fmt.bold(report.activeModel.alias)} (${report.activeModel.provider}/${report.activeModel.model})`);
        console.log();
