import { CostController } from '@berkelium/config';
import { AuthCommand } from './auth.js';
export class CloudCommand {
    static async run(themeManager, configManager, authStore, router, subcommand = 'status', arg1, arg2) {
        ...
        switch (subcommand.toLowerCase()) {
            ...
            case 'use': {
                ...
                try {
                    ...
                    console.log(fmt.success(`✓ Active cloud model set to ${target.providerId}/${target.modelId}`));
                }
                catch (err) {
